...
"}")
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(471, 430, 71, 21))
        font = QtGui.QFont()
        font.setFamily("Gill Sans MT")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.pushButton_8.setStyleSheet("border-top-left-right-radius:5px;\n"
"border-bottom-left-right-radius:5px;\n"
"")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/image/4631537.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.serial_port = serial.Serial('COM11', 9600)  # Update 'COM1' with the correct port and baudrate
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_5.setText(_translate("MainWindow", "Tample"))
